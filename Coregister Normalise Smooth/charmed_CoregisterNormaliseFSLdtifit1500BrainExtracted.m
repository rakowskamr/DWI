...
TED_name = TED_name(1).name;
 ...
 % Check for old .nii file 
% oldTED =[];
% files = dir;
% files_name = {files.name};
% size_files_name = length(files_name);
% 
%             
%             for i = 1:size_files_name
%                 x = strfind(files_name(i), 'TED.nii'); % are there any files that are nifti?
%                 if cellfun('isempty',x)
%                     oldTED(i) = 0; % no nii file
%                 else
%                     oldTED(i) = 1; % yes there is a nii file
%                     fprintf('There is an old TED file \n');
%                 end               
%             end
% 
% if sum(oldTED) == 1
...
Tdir_session = [Tdir_ppnt Tfname '/']; % this is correct
%dir_session = [dir_ppnt 'S1toAnalyse/']; % this for test
cd(Tdir_session);
...
%matlabbatch{1}.spm.spatial.coreg.estimate.ref = {'/home/c1813013/Desktop/data/010320-601_p2/S1_01032020/3_t1_mprage/3_t1_mprage_t1_mprage_20200301192706_3.nii,1'};
...
%matlabbatch{1}.spm.spatial.coreg.estimate.source = {'/cubric/collab/354_sleepms/CHARMED_preprocessing/p2/S1_SOLID_CHARMED/p2_volumes/2_CHARMED_AP_CHARMED_AP_20200301202909_2_gibbsCorrSubVoxShift_TED_brain.nii,1'};
matlabbatch{2}.spm.spatial.coreg.estimate.source = {TEDnii_file};
    
%matlabbatch{1}.spm.spatial.coreg.estimate.other = {
%                                                   '/cubric/collab/354_sleepms/CHARMED_preprocessing/p2/S1_SOLID_CHARMED/p2_volumes/2_CHARMED_AP_CHARMED_AP_20200301202909_2_gibbsCorrSubVoxShift_TED_dtFit_linear_MD.nii,1'
%                                                   '/cubric/collab/354_sleepms/CHARMED_preprocessing/p2/S1_SOLID_CHARMED/p2_volumes/2_CHARMED_AP_CHARMED_AP_20200301202909_2_gibbsCorrSubVoxShift_TED_dtFit_linear_FA.nii,1'
%                                                   '/cubric/collab/354_sleepms/CHARMED_preprocessing/p2/S1_SOLID_CHARMED/p2_volumes/2_CHARMED_AP_CHARMED_AP_20200301202909_2_gibbsCorrSubVoxShift_TED_charmed_standard_FRtot.nii,1'
%                                                   };
...
%matlabbatch{2}.spm.spatial.normalise.write.subj.def = {'/home/c1813013/Desktop/data/010320-601_p2/S1_01032020/3_t1_mprage/y_3_t1_mprage_t1_mprage_20200301192706_3.nii'};
...
matlabbatch{3}.spm.spatial.normalise.write.woptions.bb = [-78 -112 -70
                                                          78 76 85];
matlabbatch{3}.spm.spatial.normalise.write.woptions.vox = [2 2 2]; %check XNATA - yes, its 2mm
