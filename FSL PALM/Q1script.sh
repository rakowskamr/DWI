...
name="PCA_sexagePSQIrandlearningNoP12newPCA5000" #change this and studyDir!!!!
...
analysisDir=/cubric/collab/354_sleepms/PALM/Results/"$question"/"$map"/"$question"_"$map"_"$name"_"$mask" #added $map
